...
void SimFrameListener::updateStats ( void )
{
...
SimFrameListener::SimFrameListener ( RenderWindow * win,
                                     Camera * cam,
...
SimFrameListener::~SimFrameListener (  )
{
    if ( mInputTypeSwitchingOn )
    {
...
bool SimFrameListener::processUnbufferedKeyInput ( const FrameEvent & evt )
{
    ...
    if ( mInputTypeSwitchingOn && mInputDevice->isKeyDown ( KC_M )
         && mTimeUntilNextToggle <= 0 )
    {
        switchMouseMode (  );
    ...
    if ( mInputTypeSwitchingOn && mInputDevice->isKeyDown ( KC_K )
         && mTimeUntilNextToggle <= 0 )
    {
...
bool SimFrameListener::processUnbufferedMouseInput ( const FrameEvent & evt )
{
...
void SimFrameListener::moveCamera (  )
{
...
void SimFrameListener::showDebugOverlay ( bool show )
{
    Overlay *o =
        ( Overlay * ) OverlayManager::getSingleton (  ).
...
bool SimFrameListener::frameStarted ( const FrameEvent & evt )
{
...
bool SimFrameListener::frameEnded ( const FrameEvent & evt )
{
    updateStats (  );
    return true;
}

void SimFrameListener::switchMouseMode (  )
{
...
void SimFrameListener::switchKeyMode (  )
{
...
void SimFrameListener::keyClicked ( KeyEvent * e )
{
    if ( e->getKeyChar (  ) == 'm' )
    {
        switchMouseMode (  );
...
void SimFrameListener::keyPressed ( KeyEvent * e )
{
}
void SimFrameListener::keyReleased ( KeyEvent * e )
{
}
