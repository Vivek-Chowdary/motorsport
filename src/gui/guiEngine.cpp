...
{
    ( ( GuiEngine * ) clientdata )->getSystemData (  )->guiData.nextMenuIndex =
        2;
...
{
    ( ( GuiEngine * ) clientdata )->getLog (  )->put ( LOG_INFO,
                                                       "Starting simulation." );
...
{
    ( ( GuiEngine * ) clientdata )->getSystemData (  )->graphicsData.width =
        800;
    ( ( GuiEngine * ) clientdata )->getSystemData (  )->graphicsData.height =
        600;
...
int GuiEngine::optionsMenu ( void )
{
    ...
    PG_Button buttonSetRes800 ( NULL, 1, PG_Rect ( 230, 50, 180, 50 ),
                                "800x600" );

    buttonSetRes800.SetTransparency ( 128, 255, 64 );
    buttonSetRes800.SetEventCallback ( MSG_BUTTONCLICK, setRes800_handler,
                                       this );
    buttonSetRes800.Show (  );

    PG_Button buttonSetRes640 ( NULL, 1, PG_Rect ( 230, 100, 180, 50 ),
                                "640x480" );

    buttonSetRes640.SetTransparency ( 128, 255, 64 );
    buttonSetRes640.SetEventCallback ( MSG_BUTTONCLICK, setRes640_handler,
                                       this );
...
int GuiEngine::mainMenu ( void )
{
    ...
    PG_Button buttonStartSim ( NULL, 1, PG_Rect ( 230, 50, 180, 50 ),
                               "Start simulation" );
    ...
    PG_Button buttonOptionsMenu ( NULL, 1, PG_Rect ( 230, 100, 180, 50 ),
                                  "Options Menu" );

    buttonOptionsMenu.SetTransparency ( 128, 255, 64 );
    buttonOptionsMenu.SetEventCallback ( MSG_BUTTONCLICK, optionsMenu_handler,
                                         this );
